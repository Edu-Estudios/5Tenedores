    ...
    return (
        <View style={styles.viewBody}>
            <View style={styles.viewRating}>
                <AirbnbRating
                    /* Indica el numero máximo de estrellas que va a tener el rating */ 
                    count={5}
                    /* Los nombre que aparecen cuando pulsas en una estrella */
                    reviews={["Pésimo", "Deficiente", "Normal", "Muy Bueno", "Excelente"]}
                    defaultRating={0}
                    /* Tamaño de las estrellas */
                    size={35}
                    /* Función de tipo flecha que devuelve el valor de las estrellas */
